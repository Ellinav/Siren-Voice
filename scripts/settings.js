...
export const defaultSettings = Object.freeze({
    bgm: {
        ...
        libraries: {
            default: [
                { name: "深海潜流", url: "https://example.com/bgm1.mp3" },
                { name: "雨夜回响", url: "https://example.com/bgm2.mp3" },
            ],
        },
        // 🌟 新增：SFX 效果音库
        ...
        sfx_libraries: {
            default: [
                { name: "心跳", url: "https://example.com/heartbeat.mp3" },
                { name: "海浪", url: "https://example.com/wave.mp3" },
            ],
        },
        // 🌟 新增：旁白滚动样式
        karaoke_style: {
...
export function getSirenSettings() {
    ...
    if (!context || !context.extensionSettings) {
        console.warn(
            "[Siren Voice] SillyTavern context 未就绪，使用默认设置。",
        );
