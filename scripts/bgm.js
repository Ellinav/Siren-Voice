            ...
            <div id="siren-bgm-settings-body" style="${localBgmState.enabled ? "" : "display: none;"}">
                ...
                <div style="background: rgba(15, 23, 42, 0.6); padding: 12px; border-radius: 8px; border: 1px solid #334155;">
                    <div style="display: flex; gap: 12px; margin-bottom: 15px; align-items: center;">
                        <span style="color: #e2e8f0; font-weight: bold; font-size: 14px; white-space: nowrap;">当前背景库</span>
                ...
                <div class="siren-section-title" style="margin-top: 24px;">
                    <i class="fa-solid fa-volume-high" style="color: #fbbf24;"></i> 浅水回声 (SFX)
                </div>

                <div style="background: rgba(15, 23, 42, 0.6); padding: 12px; border-radius: 8px; border: 1px solid #334155;">
                    <div style="display: flex; gap: 12px; margin-bottom: 15px; align-items: center;">
                        <span style="color: #e2e8f0; font-weight: bold; font-size: 14px; white-space: nowrap;">当前效果音库</span>
...
function renderBgmAll() {
    ...
    if (sfxSelect) {
        ...
        Object.keys(localBgmState.sfx_libraries).forEach((listName) => {
            ...
            option.value = listName;
            option.textContent = listName;
            if (listName === localBgmState.sfx_current_list)
...
function renderBgmRows() {
    ...
    container.innerHTML = "";
    const currentLib =
        localBgmState.libraries[localBgmState.current_list] || [];
...
function bindBgmEvents() {
    ...
    document
        ...
        .addEventListener("change", (e) => {
            ...
            if (wrapper)
                wrapper.style.display = localBgmState.auto_play
                    ? "flex"
                    : "none";
        });
    ...
    document
        ...
        .addEventListener("click", () => {
            if (
                ...
                delete localBgmState.sfx_libraries[
                    localBgmState.sfx_current_list
                ];
                localBgmState.sfx_current_list = "default";
                renderBgmAll();
            }
